...
<div class="content-wrapper">
	...
	<div class="page-title">
		<div>
			<h1><i class="fa fa-clock-o"></i> Add Quality Error Log </h1>
		</div>
				...
				<div class="col-md-12">
					<div class="bs-component">
						<div class="tab-content" id="myTabContent">
							...
							<form class="" name="add_quality_errorlog" id="add_quality_errorlog" method="post" action="<?php echo base_url('quality_error_log/save_quality_error_data');?>">
								<div class="tab-pane fade active in" id="Add">
									<div id="dynamic_field">
										<div class="row">
											...
											<div class="form-group">
													...
													<input class="form-control" type="text" id="analyzer_report_date" name="analyzer_report_date" placeholder="Select Date" readonly="">
												</div>
											</div>	
											...
											<div class="form-group">
													<label class="control-label">Self Checker</label>
													 ...
													 <select class="form-control" id="self_checker_name" name="self_checker_name">
														<option value="">Select self checker name</option>
														<?php foreach($getListOfEmployees as $key => $employeeName): ?>
														<option value="<?php echo $employeeName->empId;?>" <?php echo set_select('self_checker_name', $employeeName->empId)?>><?php echo ucfirst($employeeName->name);?></option>
														<?php endforeach; ?>
													 </select>
										...
										<div class="row">
                                                ...
                                                <div style="padding-left:20px; color: #950606">
                                                    <h3>Add Analyzer Information</h3>
                                                </div>
											...
											<div class="col-md-3">											
												...
												<div class="form-group">
													<label class="control-label">Analyzer</label>
													 ...
													 <select class="form-control" id="analyzer_name" name="analyzer_name">
														<option value="">Select analyzer name</option>
														<?php foreach($getListOfEmployees as $key => $employeeName): ?>
														<option value="<?php echo $employeeName->empId;?>" <?php echo set_select('analyzer_name', $employeeName->empId)?>><?php echo ucfirst($employeeName->name);?></option>
														<?php endforeach; ?>
													 </select>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select class="form-control" id="analyzer_num_of_errors" name="analyzer_num_of_errors">
														<option value="">Choose number of errors</option>
														<?php for($errCnt = 0; $errCnt <= 100; $errCnt++): ?>
															<option value="<?php echo $errCnt; ?>"><?php echo $errCnt; ?></option>
														<?php endfor; ?>	
													</select>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<input class="form-control" type="text" id="analyzer_link" name="analyzer_link" placeholder="Please enter link">
													<!-- <label style="font-size:12px;">For example your adding link like : <span style="color:#F44336">https://www.elogictech.com/</span></label> -->
												</div>
											</div>	
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<textarea class="form-control" id="analyzer_comments" name="analyzer_comments" rows="1"></textarea>
												</div>
											</div>
										</div>
										...
										<div class="row">
                                             <div style="padding-left:20px; color: #950606">
                                                    <h3>Add Reviewer Information</h3>
                                                </div>
											<div class="col-md-3">											
												<!-- <div class="form-group">
													<label class="control-label">Task</label>
												...
												<div class="form-group">
													<label class="control-label">Reviewer Name</label>
													 ...
													 <select class="form-control" id="reviewer_name" name="reviewer_name" >
														...
														<?php foreach($getListOfEmployees as $key => $employeeName): ?>
														<option value="<?php echo $employeeName->empId;?>" <?php echo set_select('reviewer_name', $employeeName->empId)?>><?php echo ucfirst($employeeName->name);?></option>
														<?php endforeach; ?>
													 </select>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select class="form-control" id="reviewer_num_of_errors" name="reviewer_num_of_errors">
														<option value="">Choose number of errors</option>
														<?php for($errCnt = 0; $errCnt <= 100; $errCnt++): ?>
															<option value="<?php echo $errCnt; ?>" ><?php echo $errCnt; ?></option>
														<?php endfor; ?>	
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<input class="form-control" type="text" id="reviewer_link" name="reviewer_link" placeholder="Please enter link" value="">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<textarea class="form-control" id="reviewer_comments" name="reviewer_comments" rows="1" ></textarea>
												</div>
											</div>
										</div>
										<!-- Reviewer fill the information -->
									...
									<div class="card-footer" id="hideAftersumitButton">
										<button class="btn btn-primary icon-btn"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Quality Error Log</button>
...
<script type="text/javascript">
	$("form[name='add_quality_errorlog']").validate({
		...
		rules: {
			...
			analyzer_report_date: {
				required: true
			},
			self_checker_name: {
				required: true
			},
			analyzer_num_of_errors: {
				required: function() {
					return $("#analyzer_name").val() !== "";
				}
			},
            analyzer_link: {
				required: function() {
		...
		messages: {
			...
			analyzer_report_date: "Please Select Date",
			self_checker_name: "Select Self Checker Name",
			analyzer_num_of_errors: "Please choose number of errors if analyzer is selected",
            analyzer_link : "Please add link",
            reviewer_num_of_errors: "Please choose number of errors if reviewer is selected",
            reviewer_link : "Please add link"
		},
