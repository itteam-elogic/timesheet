...
<?php 
   ...
   $getUpdateId = $this->uri->segment('3');
	...
	foreach($updateReviewerData as $getAnalyzerData){ 
...
<div class="content-wrapper">
	...
	<div class="page-title">
		<div>
			<h1><i class="fa fa-clock-o"></i> Reviewer Quality Error Log </h1>
		</div>
				...
				<div class="col-md-12">
					<div class="bs-component">
						<div class="tab-content" id="myTabContent">
							...
							<form class="" name="reviewer_add_quality_errorlog" id="reviewer_add_quality_errorlog" method="post" action="<?php echo base_url('quality_error_log/reviewer_updated_data');?>">
								<input type="hidden" name="reviwer_updated_id" id="reviwer_updated_id" value="<?php echo $getAnalyzerData->qty_error_id;?>">
								<div class="tab-pane fade active in" id="Add">
										...
										<div class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<input class="form-control" type="text" id="analyzer_link" name="analyzer_link" placeholder="Please enter link" value="<?php echo $getAnalyzerData->analyzer_link;?>" >
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<textarea class="form-control" id="analyzer_comments" name="analyzer_comments" rows="1" ><?php echo $getAnalyzerData->analyzer_comments;?></textarea>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<input class="form-control" type="text" id="reviewer_link" name="reviewer_link" placeholder="Please enter link" value="<?php echo $getAnalyzerData->reviewer_link;?>">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<textarea class="form-control" id="reviewer_comments" name="reviewer_comments" rows="1" ><?php echo $getAnalyzerData->reviewer_comments;?></textarea>
												</div>
											</div>
										</div>
										<!-- Reviewer fill the information -->
									...
									<div class="card-footer" id="hideAftersumitButton">
										<button class="btn btn-primary icon-btn"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Reviewer Comments</button>
