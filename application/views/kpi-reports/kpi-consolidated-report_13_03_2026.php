...
if (!empty($getkpiReports)) {
    foreach ($getkpiReports as $kpiResult) {
        ...
        // Calculate monthly values (use correct year per month so MEP and Architecture both get data)
...
<table id="employeeTable" style ="margin-left: -22px; " class="table table-bordered">
    ...
    <th class="sortable" data-column="0" title="Department">Dept</th>                                                
    <th class="sortable" data-column="1" title="Reporting Manager">Reporting Manager</th>
    <th class="sortable" data-column="2" title="Employee ID">ID</th>
    <th class="sortable" data-column="3" title="Employee Name">EE</th>
...
if (!empty($getkpiReports)):
    ...
    foreach ($getkpiReports as $kpiResult):
        ...
        foreach ($monthYearPairsDesc as $monthYear):
            ...
            $getTotalProductionH = $this->kpi_reports_model->empProductionHoursMonthWiseCons($kpiResult->empId, $month, $yearForMonth);
