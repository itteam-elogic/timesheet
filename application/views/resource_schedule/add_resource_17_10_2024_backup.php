...
<?php 
   ...
   $getListOfTask		   	= $this->task_model->getTaskName($taskProjectId); // List of Clients
	...
	//Department select by default Manger wise department.
		...
		if(in_array($memberLoginID, array('146','230','149'))):
	
				$department  = 'MEP';
				$bgColour = 'style="background:rebeccapurple; color:white; font-weight: bold"';
		
		elseif(in_array($memberLoginID, array('41','47','71'))):
	
				$department  = 'Architectural';
				$bgColour = 'style="background:rebeccapurple; color:white; font-weight: bold"';

		elseif(in_array($memberLoginID, array('53','155'))):
		...
		elseif(in_array($memberLoginID, array('455'))):
											...
											<div class="col-md-3">
											 ...
											 <div class="col-md-3">
                                                <div class="form-group">
                                                   ...
                                                   <select class="form-control" id="department" name="department" <?=$bgColour?>>
														...
														<option value="MEP" <?=$department == 'MEP' ? 'selected="selected"' : '';?>>MEP</option>
...
<script type="text/javascript">
    ...
    /* DatePicker */
        ...
        $("form[name='add_emp_timelog22']").validate({
   ...
   jQuery('#client_Id1,#project_Id1,#task_Id1,#team_member,#emp_time_hours').select2(); // Autosuggest list
