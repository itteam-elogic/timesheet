	...
	<div class="googoose-wrapper">
		...
		<div class="row">
			<section title="Agreement">
				<div class="text-left">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This Agreement is made and entered as of <?=date_format($agreement_date,"d F  Y");?>, between eLogicTech Solutions Inc(hereafter referred to as "Vendor"), a US company with Registered offices at "1312 17th Street, Unit 2229, Denver, Colorado 80202" and <?=$getServiceData->client_name;?> (hereafter referred to as "Client"), a corporation with its primary place of business at "<?=$getServiceData->client_adress;?>" (each a "party" and collectively the "parties").</p>
		...
		<div class="row">
            <section title="Payment Terms">
				<p><b>Virtual post box address for Check Deposits</b></p>
				<ul style="list-style-type: none;">
					<li>1710 KELLER PARKWAY #6162</li>
			...
			<section title="Bank Details">
				<p><b>Please find bank details for processing the payment though Wires/ACH ,as below</b></p>
				<table class="table tableb sow_table">
					<tbody class="table-group-divider tableb">
						<tr>
							<td style="width:40%;">Company Name</td>
							<td>: ELOGICTECH SOLUTIONS INC</td>
						</tr>
						<tr>
							<td style="width:40%;">Email Address</td>
							<td>: accounts@elogictech.com</td>
						</tr>
						<tr>
						...
						<tr>
							<td style="width:40%;">Bank Address</td>
							<td>: 222 Broad Way, New York</td>
						</tr>
						<tr>
							<td style="width:40%;">Bank City, State, Zip Code</td>
							<td>: New York-10038</td>
						</tr>
						<tr>
							<td style="width:40%;">Routing Number</td>
							<td>: 026009593(Wires)</td>
						</tr>
						<tr>
							<td style="width:40%;">Routing Number</td>
							<td>: 123103716 (ACH)</td>
						...
						<tr>
							...
							<td>: BOFAUS3N (US dollars or unknown currency)</td>
						</tr>
						<tr>
						...
						<tr>
							<td style="width:40%;">Bank Account Type</td>
							<td>: Checking</td>
						</tr>
					</tbody>
				</table>
				<p>For processing payments through Zelle, please use the following details: <br><b>Zelle:</b> accounts@elogictech.com</p>
			</section>
		</div>
		...
		<div class="row googoose footer">
			...
			<section title="Address">
				<div class="text-center footer" style="font-size:12px;">
					<p>eLogicTech Solutions INC. VOIP: (415) 738 0642</p><p>Development Center: 1312 17th Street, Unit 2229, Denver, Colorado 80202.</p><p>Tel: +91-40-65212232 E-Mail: <a href="mailto:accounts@elogictech.com">accounts@elogictech.com</a> URL: <a href="https://www.elogictech.com/">www.elogictech.com</a></p>
   ...
   <div class="row googoose footer">
        <section title="Address">
            ...
            <div class="text-center footer" style="font-size:12px;">
                ...
                <p>Development Center: 1312 17th Street, Unit 2229, Denver, Colorado 80202</p>
