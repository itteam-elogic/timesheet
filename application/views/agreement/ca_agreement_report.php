	...
	<div class="googoose-wrapper">
		...
		<div class="row">
			...
			<section title="Scope of Services">
				<div>
					...
					<p>This agreement is being made in response to the Client's request for further assistance with updating Revit Model as per the received red lines for <b>"<?=$getServiceData->project_name;?>"</b> Project.</p>
			...
			<section title="Deliverables">
				<div>
					<p><b class="text-uppercase">Deliverables</b></p>
					<?=$getServiceData->deliverables;?>
				</div>
				<div>
					<p><b class="text-uppercase">Provided by Client</b></p>
		...
		<div class="row">
			<section title="Time and Cost">
				<p><b class="text-uppercase">Time and Cost Estimate for Developing Autocad Drawings:</b></p>
				<ul>
			...
			<section title="Payment Terms">
				<p><b class="text-uppercase">Payment Terms</b></p>
				<ol>
					<li>Payment Terms &#8209; Invoice will be raised after completion of the project.</li>
		...
		<div class="row">
			<section title="Bank Details">
				<p><b>Please find bank details for processing the payment, as below.</b></p>
		...
		<div class="row">
			<section title="Terms and Conditions">
				<p><b class="text-uppercase">Terms and Conditions</b></p>
				<ol>
		...
		<div class="row googoose footer">
			...
			<section title="Address">
				<div class="text-center footer" style="font-size:12px;">
					<p>eLogicTech Solutions Inc 229 Brannan St Unit 4J, San Francisco, CA 94107-4046, USA. VOIP: (415) 634 6120</p>
					<p>Development Center: Plot No 72, The May Flower, P & T Colony, Secunderabad &#8209; 500 009, Telangana State, India.</p>
					<p>Tel: +91-40-27892176 E-Mail: <a href="mailto:accounts@elogictech.com">accounts@elogictech.com</a> URL: <a href="https://www.elogictech.com/">www.elogictech.com</a></p>
	...
	<div class="googoose-wrapper">
			...
			<section title="Services">
				<div class="text-left">
					<ol>
							...
							<section title="Contact Details:">
								<div class="col-md-12">
									<table class="table tableb sow_table">
										<thead>
											<tr class="tableb">
												<th scope="col">List of Consultants:</th>
											</tr>
										</thead>
										<tbody class="table-group-divider tableb">
											<tr style="line-height:0.5;">
												<th style="width:30%;">Project Contact Details:</th>
												<td>Contact Name</td>
												<td><?=$getServiceData->project_contact_name;?></td>
											</tr>
											<tr>
												<th style="width:30%"></th>
												<td>Email Id</td>
												<td><?=$getServiceData->project_email_id;?></td>
											</tr>
											<tr>
												<th style="width:30%"></th>
												<td>Contact No</td>
												<td><?=$getServiceData->project_contact_number;?></td>
											</tr>
											<tr>
												<th style="width:30%">Billing Contact Details:</th>
												<td>Contact Name</td>
												<td><?=$getServiceData->billing_contact_name;?></td>
											</tr>
											<tr>
												<th style="width:30%"></th>
												<td>Email Id</td>
												<td><?=$getServiceData->billing_email_id;?></td>
											</tr>
											<tr>
												<th style="width:30%"></th>
												<td>Contact No</td>
												<td><?=$getServiceData->billing_contact_number;?></td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<li class="mb-3"><b>Payment Terms:</b>
							<ul class="float-start listlower">
								...
								<div class="row">
									<section title="Bank Details martp">
										<p><b>Please find bank details for processing the payment, as below.</b></p>
						...
						<li class="mb-3">The client can escalate their concern to eLogicTech Management Team
							<p class="text-center">Contact name: Rupali Modi</p>
		...
		<div class="row">
			<section title="Consultants">
				<div class="col-md-12" style="margin-top:5em;">
					<p class="text-center"><b>Appendix A: List of Designated Consultants</b></p>
					<p>List of Designated Consultants:</p>
				</div>
				<div class="col-md-12">
		...
		<div class="row googoose footer">
			<section title="Address">
				<hr>
				<div class="text-center footer" style="font-size:12px;">
					<p>eLogicTech Solutions Inc 229 Brannan St Unit 4J, San Francisco, CA 94107-4046, USA. VOIP: (415) 634 6120</p><p>Development Center: Plot No 72, The May Flower, P & T Colony, Secunderabad &#8209; 500 009, Telangana State, India.</p><p>Tel: +91-40-27892176 E-Mail: <a href="mailto:accounts@elogictech.com">accounts@elogictech.com</a> URL: <a href="https://www.elogictech.com/">www.elogictech.com</a></p>
					<!--<span class="googoose currentpage"></span>
					<span class="googoose totalpage"></span> -->
				</div>
			</section>
...
<script>
	function exportDoc() { // Word document download function     
